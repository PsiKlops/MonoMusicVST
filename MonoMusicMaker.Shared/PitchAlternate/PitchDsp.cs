...
namespace Pitch
{
    ...
    public class PitchDsp
    {
        ...
        /// </summary>
        private float InterpolateHermite(float fY0, float fY1, float fY2, float fY3, float frac) //https://stackoverflow.com/questions/5390957/explanation-of-interpolate-hermite-method
        {
            var c1 = 0.5f * (fY2 - fY0);
